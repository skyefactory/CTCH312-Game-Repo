...
var cook_result: ItemData = null # If this item is cookable, this variable will hold the resulting item after cooking, if not cookable this will be null
...
# this field would allow us to control what sort if kitchen items the player can interact with, 
